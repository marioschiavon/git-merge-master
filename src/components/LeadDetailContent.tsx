        ...
        {lead.whatsapp && (
          <div className="flex items-center gap-2 text-sm">
            ...
            {lead.whatsapp_valid === true && (
              <Badge variant="outline" className="ml-1 h-5 px-1.5 text-[10px] border-emerald-300 text-emerald-700" title={lead.whatsapp_checked_at ? `Verificado em ${new Date(lead.whatsapp_checked_at).toLocaleString("pt-BR")}` : "Número validado no WhatsApp"}>
                ✓ WhatsApp válido
              </Badge>
            )}
